...
int main(int argc, char **argv) {
  ...
  cudaHostAlloc(&resultRef, numCRows * numCColumns * sizeof(DataType), cudaHostAllocDefault);

  double time0 = timestop() - start0;
  printf("Pinned memory allocation %f seconds.\n", time0);
