...
int main(int argc, char **argv) {
  ...
  cudaMallocManaged((void**)&hostA, numARows * numAColumns * sizeof(DataType));
  cudaMallocManaged((void**)&hostB, numBRows * numBColumns * sizeof(DataType));
  cudaMallocManaged((void**)&hostC, numCRows * numCColumns * sizeof(DataType));
  cudaMallocManaged((void**)&resultRef, numCRows * numCColumns * sizeof(DataType));
  ...
  gemm<<<dim3(dimGridx,dimGridy,1),dim3(dimBlockx,dimBlocky,1)>>>(hostA,hostB,hostC,numARows,numAColumns,numBRows,numBColumns);
